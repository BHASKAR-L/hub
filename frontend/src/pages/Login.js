      ...
      <div className="w-full max-w-sm sm:max-w-md relative z-10">
        ...
        <div className="text-center mb-6 lg:mb-8">
          <div className="flex flex-col items-center gap-3 lg:gap-4 mb-4 lg:mb-6">
            ...
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-heading font-bold text-white tracking-wider uppercase">BLURA HUB</h1>
          ...
          <p className="text-[hsl(210,20%,75%)] text-xs sm:text-sm tracking-wide uppercase">Threat Intelligence Center</p>
        </div>
        ...
        <div className="bg-white/95 backdrop-blur-xl border-2 border-[hsl(43,96%,50%)]/30 rounded-xl p-5 sm:p-6 lg:p-8 shadow-2xl shadow-black/20">
          <div className="flex items-center gap-3 mb-5 lg:mb-6 pb-3 lg:pb-4 border-b border-border">
            ...
            <div>
              <h2 className="text-lg lg:text-xl font-heading font-bold text-foreground">Secure Access</h2>
              <p className="text-[10px] lg:text-xs text-muted-foreground">Authorized Personnel Only</p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-5" data-testid="login-form">
            <div className="space-y-1.5 lg:space-y-2">
              ...
              <Input
                ...
                className="h-11 lg:h-12 border-2 focus:border-primary focus:ring-primary/20 text-base"
              />
            </div>
            <div className="space-y-1.5 lg:space-y-2">
            ...
            <Button
              type="submit"
              className="w-full h-11 lg:h-12 text-sm lg:text-base font-semibold bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary shadow-lg shadow-primary/25 transition-all duration-200 hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98]"
              disabled={loading}
          ...
          <div className="mt-5 lg:mt-6 p-3 lg:p-4 bg-gradient-to-r from-primary/5 to-primary/10 rounded-lg border border-primary/20">
            <p className="font-semibold text-xs lg:text-sm mb-1.5 lg:mb-2 flex items-center gap-2 text-primary">
              <Shield className="h-3 w-3 lg:h-4 lg:w-4" />
              Demo Credentials
            </p>
            <p className="text-muted-foreground text-xs lg:text-sm">Email: admin@blurahub.com</p>
            <p className="text-muted-foreground text-xs lg:text-sm">Password: admin123</p>
          </div>
        </div>

        {/* Footer */}
        <div className="mt-4 lg:mt-6 text-center">
          <p className="text-[hsl(210,20%,60%)] text-[10px] lg:text-xs">© 2026 BLURA HUB • Secure Connection</p>
        </div>
      </div>
    </div>
  );
